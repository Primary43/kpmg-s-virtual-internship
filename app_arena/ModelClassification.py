...
def preprocess_trainingdata(df, label_column, test_size=0.2, random_state=42):
    ...
    one_hot_cols = X.select_dtypes(include=['uint8']).columns
    ...
    return X_train_scaled, X_test_scaled, y_train_encoded, y_test_encoded, n_features, n_classes, label_encoder, scaler
